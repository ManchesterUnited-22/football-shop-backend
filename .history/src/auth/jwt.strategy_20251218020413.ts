...
  constructor(private usersService: UsersService) { 
    super({
      // ⭐️ SỬA ĐỔI TẠI ĐÂY: Sử dụng fromExtractors để lấy token từ 2 nguồn
      jwtFromRequest: ExtractJwt.fromExtractors([
        // 1. Lấy từ Header (Cho các API thông thường)
        ExtractJwt.fromAuthHeaderAsBearerToken(),
        // 2. Lấy từ Query Parameter 'token' (Dành riêng cho SSE)
        (request: Request) => {
