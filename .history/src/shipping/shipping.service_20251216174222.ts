...
export class ShippingService {
    ...
    async createShippingLabel(
        // Kiểu dữ liệu đầu vào đã được định nghĩa chính xác từ OrderService
        ...
        const payload = {
            ...
            // ✅ SỬA LỖI paymentMethod: Dùng Optional Chaining vì là String? trong DB
            ...
            items: order.items.map(item => ({ 
                // ✅ SỬA LỖI product: Truy cập trực tiếp item.product.name vì kiểu dữ liệu đã cam kết là có
